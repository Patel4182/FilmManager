<?php 
  ...
  if (!isset($_SESSION['login'])) {
    ...
    header("Location: ".$actual_link);
      ...
      $films_result = pg_query($db_con_status, "SELECT * FROM get_one_submovie($id,$uid)");
...
<div id="shell">
  <div id="header">
    <br>
    <h1 style="color:white;">Entertainment</h1>
    ...
    <div class="container-fluid">
          <div class="row">
            ...
            <div class=" col-md-6" style=" margin-left: 25px;background-color:white; border-radius: 10px;opacity: 0.5;">
             ...
             <br>
             <form action="../action.php?operation=change_rating&movie_id=<?php echo $id?>&user_id=<?php echo $uid ?>&submovie=1" method="POST">
             <label>Rating</label>
             <select name="rating">
